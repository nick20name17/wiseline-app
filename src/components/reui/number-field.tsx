...
const numberFieldGroupVariants = cva(
  'border-input aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus-within:has-aria-invalid:border-destructive focus-within:has-aria-invalid:ring-destructive/20 dark:focus-within:has-aria-invalid:ring-destructive/40 dark:bg-input/30 focus-within:border-ring focus-within:ring-ring/50 relative flex w-full justify-between rounded-lg border bg-transparent transition-colors focus-within:ring-3 data-disabled:pointer-events-none data-disabled:opacity-50',
  {
    variants: {
      size: {
        sm: 'h-7 text-sm',
